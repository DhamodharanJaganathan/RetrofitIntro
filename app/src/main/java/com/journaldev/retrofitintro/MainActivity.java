...
import com.journaldev.retrofitintro.RetryPolicy.CustomCallback;
import com.journaldev.retrofitintro.RetryPolicy.RetryHelper;
import com.journaldev.retrofitintro.pojo.MultipleResource;
import com.journaldev.retrofitintro.pojo.MultipleResource.Datum;
...
public class MainActivity extends AppCompatActivity {
    ...
    call2.enqueue(new Callback<UserList>() {
      ...
      public void onResponse(Call<UserList> call, Response<UserList> response) {
        ...
        for (UserList.Datum datum : datumList) {
          Toast.makeText(getApplicationContext(),
              "id : " + datum.id + " name: " + datum.first_name + " " + datum.last_name
  ...
  private void Retrypolicy() {
    ...
    Call<RetrypolicyPOJO> call = apiInterface.doGetListResources_retry();

    // Now you can set your own success code for more customization
    RetryHelper.setSuccessCode(200);

    RetryHelper.enqueueRetry(call, 3, new CustomCallback<RetrypolicyPOJO>() {
      @Override
      public void onFailResponse(int errorCode, Call<RetrypolicyPOJO> call,
          Response<RetrypolicyPOJO> response) {
        Log.e("Retrofit", "onFailResponse() called with: errorCode = [" + errorCode + "], call "
            + "= [" +
      ...
      @Override
      public void onFailure(Call<RetrypolicyPOJO> call, Throwable t) {
